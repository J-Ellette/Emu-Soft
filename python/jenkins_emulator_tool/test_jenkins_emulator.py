...
import unittest
import time
from jenkins_emulator import (
    JenkinsEmulator, Job, Pipeline, BuildStatus, BuildResult,
    TriggerType, create_job, create_pipeline, build_job
)


class TestJenkinsEmulator(unittest.TestCase):
    """Test Jenkins emulator basic functionality"""
    
    def setUp(self):
        """Set up test fixtures"""
        self.jenkins = JenkinsEmulator()
