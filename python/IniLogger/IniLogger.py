...
# Helper functions
def create_job(jenkins: IniLogger, name: str, description: str = "") -> Job:
    """Helper to create a job"""
    return jenkins.create_job(name, description)


def create_pipeline(jenkins: IniLogger, name: str) -> Pipeline:
    """Helper to create a pipeline"""
    return jenkins.create_pipeline(name)


def build_job(jenkins: IniLogger, job_name: str, 
