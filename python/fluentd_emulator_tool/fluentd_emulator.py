...
# Helper functions
def create_source(fluentd: FluentdEmulator, source_type: str, tag: str, **config) -> Source:
    """Helper to create a source"""
    return fluentd.add_source(source_type, tag, **config)


def create_filter(fluentd: FluentdEmulator, filter_type: str, tag_pattern: str, **config) -> Filter:
    """Helper to create a filter"""
    return fluentd.add_filter(filter_type, tag_pattern, **config)


def create_output(fluentd: FluentdEmulator, output_type: str, tag_pattern: str = "**", **config) -> Output:
